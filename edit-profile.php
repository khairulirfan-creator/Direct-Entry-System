...
$userid=$_SESSION['id'];
    $msg=mysqli_query($con,"update users set fname='$fname',contactno='$contact' where id='$userid'");
...
<html lang="en">
    <head>
        ...
        <title>Edit Profile | DIRECT ENTRY LOGIN SYSTEM</title>
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Matric no.</th>
                                       <td colspan="3"><?php echo $result['matricno'];?></td>
                                   </tr>
                                   <tr>
                                       <th>Course</th>
