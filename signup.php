...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(fname,email,password,contactno) values('$fname','$email','$password','$contact')");
...
<html lang="en">
    <head>
        ...
        <title>Login | DIRECT STUDENT ENTRY SYSTEM</title>
...
<h2 align="center">DIRECT STUDENT ENTRY SYSTEM</h2>
<hr />
...
<div class="form-floating mb-3">
<input class="form-control" id="matric" name="matric" type="matric" placeholder="phpgurukulteam@gmail.com" required />
<label for="inputmatricno">Matric number</label>
</div>

<div class="form-floating mb-3">
<input class="form-control" id="course" name="course" type="course" placeholder="phpgurukulteam@gmail.com" required />
